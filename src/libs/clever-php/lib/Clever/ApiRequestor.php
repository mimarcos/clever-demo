...
class CleverApiRequestor
{
  ...
  private function _interpretResponse($rbody, $rcode)
  {
    if ($rcode < 200 || $rcode >= 300) {
      $this->handleApiError($rbody, $rcode, $rbody);
    }
    ...
    if ($resp === null) {
      ...
      throw new CleverError("Invalid response body from API: $rbody (HTTP response code was $rcode, json error: $jsonError)", $rcode, $rbody);
    }
  ...
  public function handleCurlError($errno, $message, $httpStatusCode = null)
  {
    $apiBase = Clever::$apiBase;
    switch ($errno) {
    ...
    throw new CleverError($msg, $httpStatusCode);
  }
}
